"""
To do:
Need not only a fake user agent.
But also a fake browser agent in the headers of the request.
Can try ScrapeOps Fake Browser Headers API.

If that doesn't work, try Selenium.
"""
import requests
